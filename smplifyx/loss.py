...
from utils.vicon_mapping import VICON_BODY, VICON_HAND
...
def Loss_k3d(kp3ds,out_kp3ds,part='body',norm='l2'):
    ...
    if part=='body':
        diff_square=(kp3ds[:,VICON_BODY,:3]-out_kp3ds[:,VICON_BODY,:3])*kp3ds[:,VICON_BODY,3][...,None]
    elif part=='hand':
        diff_square=(kp3ds[:,VICON_HAND,:3]-out_kp3ds[:,VICON_HAND,:3])*kp3ds[:,VICON_HAND,3][...,None]
    elif part=='face':
...
def Loss_smooth_body(out_kp3ds,part='body'):
    ...
    if part=='body':
        kp3ds_est=out_kp3ds[:,VICON_BODY]
    elif part=='hand':
        kp3ds_est=out_kp3ds[:,VICON_HAND]
